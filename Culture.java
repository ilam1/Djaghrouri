public class Culture extends Category{
    public static String[] questions={"In which country was it a custom to bind the women's feet?",
				      ...
				      "This country follows a calendar that is seven years behind the rest of the world",
				      "In this country authorities prohibited its people from wearing yellow clothing"};
    public static String[] answers={"China","Margarita","Niue","Ethiopia","Malaysia"};
}
