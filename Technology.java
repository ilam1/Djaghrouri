public class Technology extends Woo{
    public static String[] questions={"This part of the hardware of a computer stores all your programs and files.",
				      ...
				      "This person made the first mobile phone call on April 3, 1973",
				      "Who was featured in the very first Apple Logo?"};
    public static String[] answers={"hard drive","bit","Henry Ford","Martin Cooper","Isaac Newton"};
}
