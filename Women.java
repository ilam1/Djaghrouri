public class Women extends Woo{
    public static String[] questions={"The first women's rights convention was held here. (Don't include the state)",
				      ...
				      "The Nineteenth AMendment is also known as the ___ Amendment","Who is the first woman appointed to the Supreme Court? (Full name)"};
    public static String[] answeres={"Seneca Falls", "Susan B. Anthony","Caraway","Anthony","Sandra Day O'Connor"};
}
